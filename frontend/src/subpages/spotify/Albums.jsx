...
function Albums() {
    ...
    return (
        <div className="h-screen w-screen flex flex-col items-center justify-center" style={{ backgroundColor: '#00d95b' }}>
            {!jugar ? (
                //  Pantalla de inicio (antes de JUGAR)
                <>
                    <div className="flex flex-col items-center w-[600px] h-[400]">
                        <img src={logo} className="w-[200px] h-[200px] mt-8" alt="Logo" />
                        <h1 className="text-3xl font-bold mt-3">Adivina qué álbum tiene más reproducciones en Spotify</h1>
                        <h2 className="mt-3">
                        Un juego de mayor o menor usando estadísticas de transmisión de álbumes de Spotify. Las obras de álbum se calculan en función del recuento de reproducción de todas las canciones de ese álbum. Estadísticas actualizadas Octubre 2024.</h2>
                    </div>
