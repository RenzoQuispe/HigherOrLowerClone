            ...
            {!jugar ? (
                ...
                <>
                    <div className="flex flex-col items-center w-[600px] h-[375px]">
                        ...
                        <h1 className="text-3xl font-bold mt-3">Adivina qué artista tiene más oyentes mensuales en Spotify</h1>
                        <h2 className="mt-3">
                        Un juego Higher Or Lower usando las estadísticas mensuales de los oyentes de Spotify. Estadísticas actualizadas en enero de 2025.</h2>
                    </div>
